...
export default async function Home(){
  ...
  return <div className="hanbit" id="top">
    ...
    <footer id="customer"><div className="shell footerGrid"><div><div className="footerLogo"><span>H</span><b>한빛 상품권</b></div><p>365일 24시간 간편 상품권 교환 서비스</p></div><div className="business"><p><b>상호</b><span>한빛 상품권</span></p><p><b>도메인</b><span>hanvituro.kr</span></p><p><b>운영시간</b><span>365일 24시간</span></p></div></div></footer>
  </div>
}
